<div class="container">
    ...
    <div class="row row-content">
        ...
        //&& ($iMonatIdWert < 5)
        if(($iSensorIdWert > $iAnzahlSensorenMeteo-1) && ($iJahrIdWert < 2008) ) {//Boden-Daten erst ab Mai 2008 verf�gbar

            echo "<div class='warnings1'>Boden-Daten erst ab Mai 2008 verf�gbar</div>";

        }else{

            if(($iSensorIdWert > $iAnzahlSensorenMeteo-1) && ($iJahrIdWert == 2008) && ($iMonatIdWert < 5) ) {//Boden-Daten erst ab Mai 2008 verf�gbar
                echo "<div class='warnings1'>Tageswerte f�r Boden-Daten erst ab Mai 2008 verf�gbar</div>";
            }
            ...
            echo '<td align="left" BGCOLOR="#ffff00"><b>Wert f�r</b></td>';
