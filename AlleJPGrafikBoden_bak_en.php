...
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Air Temperature' WHERE `sensoren`.`Identifikation` =0;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Soil Temperature - 5 cm' WHERE `sensoren`.`Identifikation` =7;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Soil Temperature - 10 cm' WHERE `sensoren`.`Identifikation` =8;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Soil Temperature - 50 cm' WHERE `sensoren`.`Identifikation` =9;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Soil Temperature - 100 cm' WHERE `sensoren`.`Identifikation` =10;

DE:
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Lufttemperatur' WHERE `sensoren`.`Identifikation` =0;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Bodentemperatur - 5 cm' WHERE `sensoren`.`Identifikation` =7;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Bodentemperatur - 10 cm' WHERE `sensoren`.`Identifikation` =8;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Bodentemperatur - 50 cm' WHERE `sensoren`.`Identifikation` =9;
UPDATE `MeteoVaduz`.`sensoren` SET `Bezeichnung` = 'Bodentemperatur - 100 cm' WHERE `sensoren`.`Identifikation` =10;
...
//	$oGraph->xaxis->SetTickLabels(gibXLabelFormat($oXDaten[$iAnzahlSensorenIndex],$iBildBreite)); 
	...
	$oGraph->yaxis->SetTitle('Temperature [°C]','middle');
...
//	$oGraphProf->xaxis->SetTickLabels(gibXLabelFormat($oXDaten[$iAnzahlSensorenIndex],$iBildBreite)); 
	...
	$oGraphProf->xaxis->SetTitle('Soil Depth [cm]      ','low');
	...
	$oGraphProf->yaxis->SetTitle('Temperature [°C]        ','high');
...
////////////////////////////////////////////////
	...
	// Grafik Formatieren
	$oGraphProfGrob->xaxis->SetTitle('Soil Depth [cm]      ','low');
	...
	$oGraphProfGrob->yaxis->SetTitle('Temperature [°C]        ','high');
	//$oGraphProf->yaxis->title->SetFont(FF_FONT1,FS_BOLD); 
